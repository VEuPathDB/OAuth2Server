...
CREATE TABLE "USERACCOUNTS"."GUEST_IDS" (
  "USER_ID"       NUMBER(12,0) NOT NULL ENABLE,
  "TOKEN_ID"      VARCHAR2(30 BYTE) NOT NULL ENABLE, -- note DB column is temporarily nullable for backward compatibility
  "CREATION_TIME" TIMESTAMP (6) NOT NULL ENABLE,
  CONSTRAINT "GUEST_IDS_PK" PRIMARY KEY ("USER_ID")
);

-- Token_IDs table
CREATE TABLE "USERACCOUNTS"."TOKEN_IDS" (
  "TOKEN_ID"        VARCHAR2(30 BYTE) NOT NULL ENABLE,
  "USER_ID"         NUMBER(12,0) NOT NULL ENABLE,
  "CREATION_TIME"   TIMESTAMP (6) NOT NULL ENABLE,
  "EXPIRATION_TIME" TIMESTAMP (6) NOT NULL ENABLE,
  "IS_REVOKED"      NUMBER(1) NOT NULL ENABLE,
  CONSTRAINT "TOKEN_IDS_PK" PRIMARY KEY ("TOKEN_ID")
);
...
GRANT SELECT ON "USERACCOUNTS"."TOKEN_IDS" TO "USERACCTS_R";
GRANT SELECT ON "USERACCOUNTS"."TOKEN_IDS" TO "USERACCTS_W";
GRANT INSERT ON "USERACCOUNTS"."TOKEN_IDS" TO "USERACCTS_W";
GRANT UPDATE ON "USERACCOUNTS"."TOKEN_IDS" TO "USERACCTS_W";
GRANT DELETE ON "USERACCOUNTS"."TOKEN_IDS" TO "USERACCTS_W";
