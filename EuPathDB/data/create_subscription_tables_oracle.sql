...
CREATE TABLE USERACCOUNTS.SUBSCRIPTIONS (
  ...
  "LAST_ACTIVE_YEAR" NUMBER(12,0) DEFAULT 0 NOT NULL ENABLE,
  "DISPLAY_NAME"     VARCHAR2(500 BYTE) NOT NULL ENABLE,
...
-- Payments table
CREATE TABLE USERACCOUNTS.PAYMENTS (
  "REFERENCE_NUMBER"  VARCHAR2(50) NOT NULL ENABLE,
  "PAYMENT_DATE"      VARCHAR2(30) NOT NULL ENABLE,
  "AMOUNT"            VARCHAR2(20) NOT NULL ENABLE,
  "CURRENCY"          VARCHAR2(10) NOT NULL ENABLE,
  ...
  "ENVIRONMENT"       VARCHAR2(30) NOT NULL ENABLE,
  CONSTRAINT "PAYMENTS_PK" PRIMARY KEY ("REFERENCE_NUMBER")
);
...
GRANT SELECT ON "USERACCOUNTS"."PAYMENTS" TO "USERACCTS_R";
GRANT SELECT, INSERT, UPDATE, DELETE ON "USERACCOUNTS"."PAYMENTS" TO "USERACCTS_W";
