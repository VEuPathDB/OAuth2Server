...
public class Endpoints {
  ...
  public static final String /* POST  */ AUTH_TOKEN     = "/token";          // requires client secret + auth code
  public static final String /* POST  */ BEARER_TOKEN   = "/bearer-token";   // requires client secret + auth code
